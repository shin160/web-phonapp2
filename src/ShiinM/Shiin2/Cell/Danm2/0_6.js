...
// VideoContext 各インポート
import { VideoContext as VideoContextT } from '../../../Shiin2/VideoContext/VC-T';
...
import { VideoContext as VideoContextSH2 } from '../../../Shiin2/VideoContext/VC_SH2';
...
const Cell06 = () => {
  ...
  const { blink, showBackground } = useBlink_K2(showVideoT || showVideoD || showVideoSH1 || showVideoSH2 || showVideoCH1 || showVideoCH2 || showVideoL || showVideoN);

  return (
    <TouchableOpacity style={styles.container}>
      <Image
        source={require('../DanmPict/Danm_15.png')}
