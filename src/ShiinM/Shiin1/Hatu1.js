// src\Main\Main1\Shiin1\Hatu1.js
...
import Cell011 from './Cell/Hatu1/0_11';
import Cell012 from './Cell/Hatu1/0_12';

import Cell10 from './Cell/Hatu1/1_0';
import Cell11 from './Cell/Hatu1/1_1';
import Cell12 from './Cell/Hatu1/1_2';
import Cell13 from './Cell/Hatu1/1_3';
import Cell14 from './Cell/Hatu1/1_4';
import Cell15 from './Cell/Hatu1/1_5';
import Cell16 from './Cell/Hatu1/1_6';
import Cell17 from './Cell/Hatu1/1_7';
import Cell18 from './Cell/Hatu1/1_8';
import Cell19 from './Cell/Hatu1/1_9';
import Cell110 from './Cell/Hatu1/1_10';
import Cell111 from './Cell/Hatu1/1_11';
import Cell112 from './Cell/Hatu1/1_12';
...
const CellContent = ({ index, componentKey }) => {
  ...
  if (componentKey.startsWith('0-')) {
    ...
    // 上）_0.5
    if ([0, 1, 2, 5, 6, 7, 8, 9, 10, 11].includes(index)) {
    ...
    // 上）青・2ピクセル
    if ([5, 6, 7, 8, 9, 10, 11].includes(index)) {
      additionalStyles.borderTopWidth = 2;
      additionalStyles.borderTopColor = 'blue';
    }
    // 左）青・2ピクセル
    if ([4].includes(index)) {
      additionalStyles.borderTopWidth = 2;
  ...
  if (componentKey.startsWith('1-')) {
    ...
    // 背景色：背景グレー色を消去
    if (![0, 2, 4, 5, 7, 8, 9, 11].includes(index)) {
