...
// セルのコンポーネントをインポート
import Cell00 from './Cell/Hatu2/0_0';
import Cell01 from './Cell/Hatu2/0_1';
import Cell02 from './Cell/Hatu2/0_2';
import Cell03 from './Cell/Hatu2/0_3';
import Cell04 from './Cell/Hatu2/0_4';
import Cell05 from './Cell/Hatu2/0_5';
import Cell06 from './Cell/Hatu2/0_6';
import Cell07 from './Cell/Hatu2/0_7';
import Cell08 from './Cell/Hatu2/0_8';
import Cell09 from './Cell/Hatu2/0_9';
import Cell010 from './Cell/Hatu2/0_10';
import Cell011 from './Cell/Hatu2/0_11';
import Cell012 from './Cell/Hatu2/0_12';

import Cell10 from './Cell/Hatu2/1_0';
import Cell11 from './Cell/Hatu2/1_1';
import Cell12 from './Cell/Hatu2/1_2';
import Cell13 from './Cell/Hatu2/1_3';
import Cell14 from './Cell/Hatu2/1_4';
import Cell15 from './Cell/Hatu2/1_5';
import Cell16 from './Cell/Hatu2/1_6';
import Cell17 from './Cell/Hatu2/1_7';
import Cell18 from './Cell/Hatu2/1_8';
import Cell19 from './Cell/Hatu2/1_9';
import Cell110 from './Cell/Hatu2/1_10';
import Cell111 from './Cell/Hatu2/1_11';
import Cell112 from './Cell/Hatu2/1_12';
...
const CellContent = ({ index, componentKey }) => {
  ...
  if (componentKey.startsWith('0-')) {
    ...
    // 背景色：背景グレー色を消去
    if (![0, 1, 3, 4, 9, 10, 11].includes(index)) {
  ...
  if (componentKey.startsWith('1-')) {
    ...
    // 背景色：0-2背景色の消去
    if (![0, 2, 3, 8, 9, 10].includes(index)) {
