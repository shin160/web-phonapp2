...
// セルのコンポーネントをインポート
import Cell00 from './Cell/Danm5/0_0';
import Cell01 from './Cell/Danm5/0_1';
import Cell02 from './Cell/Danm5/0_2';
import Cell03 from './Cell/Danm5/0_3';
import Cell04 from './Cell/Danm5/0_4';
import Cell05 from './Cell/Danm5/0_5';
import Cell06 from './Cell/Danm5/0_6';
import Cell07 from './Cell/Danm5/0_7';
import Cell08 from './Cell/Danm5/0_8';
import Cell09 from './Cell/Danm5/0_9';
import Cell010 from './Cell/Danm5/0_10';
import Cell011 from './Cell/Danm5/0_11';
...
const CellContent = ({ index, componentKey }) => {
  ...
  if (componentKey.startsWith('0-')) {
    ...
    // 左線_0.2(ベース)
    if ([0, 1, 2, 4, 5, 6, 7, 8, 9, 10, 11].includes(index)) {
  ...
  return (
    <View style={[styles.cellWrapper, additionalStyles]}>
      {Component && <Component />}
    </View>
  );
};
