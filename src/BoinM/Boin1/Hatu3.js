...
const CellContent = ({ index, componentKey }) => {
  ...
  if (componentKey.startsWith('0-')) {
    // 背景色のオーバーレイ設定
    if (![0, 1, 2, 3, 4, 5, 6, 9, 10, 11].includes(index)) {
    ...
    if (![0, 1, 2, 3, 4, 5, 7, 8, 9, 10].includes(index)) {
