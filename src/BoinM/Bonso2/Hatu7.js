...
// セルのコンポーネントをインポート
import Cell00 from './Cell/Hatu7/0_0';
import Cell01 from './Cell/Hatu7/0_1';
import Cell02 from './Cell/Hatu7/0_2';
import Cell03 from './Cell/Hatu7/0_3';
import Cell04 from './Cell/Hatu7/0_4';
import Cell05 from './Cell/Hatu7/0_5';
import Cell06 from './Cell/Hatu7/0_6';
import Cell07 from './Cell/Hatu7/0_7';
import Cell08 from './Cell/Hatu7/0_8';
...
const CellContent = ({ index, componentKey }) => {
  ...
  if (componentKey.startsWith('0-')) {
    // 上）_0.5
    if ([0, 2, 3, 4, 5, 6, 8, 9].includes(index)) {
  ...
  if (['0-6'].includes(componentKey)) {
    overlayColor.backgroundColor = 'rgba(0, 0, 0, 0.1)';
  }
  // 背景色を設定_2
