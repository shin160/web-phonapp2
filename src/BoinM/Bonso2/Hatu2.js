...
const CellContent = ({ index, componentKey }) => {
  ...
  // 背景色を設定_1
  if (['0-2', '0-3', '0-5', '0-6', '0-10', '0-11'].includes(componentKey)) {
    overlayColor.backgroundColor = 'rgba(0, 128, 128, 0.1)';
  }
  // 背景色を設定_2
  if (['0-4', '0-8', '0-9', '0-12'].includes(componentKey)) {
    overlayColor.backgroundColor = 'rgba(0, 128, 128, 0.03)';
  }
