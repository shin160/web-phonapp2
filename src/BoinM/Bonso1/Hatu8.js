...
// セルのコンポーネントをインポート
import Cell00 from './Cell/Hatu8/0_0';
import Cell01 from './Cell/Hatu8/0_1';
import Cell02 from './Cell/Hatu8/0_2';
import Cell03 from './Cell/Hatu8/0_3';
import Cell04 from './Cell/Hatu8/0_4';
import Cell05 from './Cell/Hatu8/0_5';
import Cell06 from './Cell/Hatu8/0_6';
import Cell07 from './Cell/Hatu8/0_7';
import Cell08 from './Cell/Hatu8/0_8';
...
const CellContent = ({ index, componentKey }) => {
  ...
  if (componentKey.startsWith('0-')) {
    ...
    // 下）赤・2ピクセル
    if ([2, 3, 4, 5, 6, 8, 9].includes(index)) {
      additionalStyles.borderBottomWidth = 2;
      additionalStyles.borderBottomColor = 'red';
    }
    // 左）_0.5
  ...
  // 背景色を設定_1
  if (['0-6'].includes(componentKey)) {
    overlayColor.backgroundColor = 'rgba(0, 128, 128, 0.1)';
  }
  // 背景色を設定_2
  if (['0-2', '0-3', '0-4', '0-5'].includes(componentKey)) {
